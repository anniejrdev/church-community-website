...
//       // Get upcoming events (date >= today) and order by date
//       const q = query(
...
//         date: doc.data().date || "",
//         day: formatDay(doc.data().date),
//         image: doc.data().image || "https://images.unsplash.com/photo-1561749748-fe2869ba7da4?w=600&auto=format&fit=crop&q=60",
...
//   // Format date for display (April 12, 2024)
...
//             <p className="text-gray-400 text-sm mt-2">Please check back later for new events.</p>
//           </div>
//         ) : (
//           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
//             {events.map((event, index) => (
...
//                       className="w-full h-full object-cover -rotate-45 scale-150"
//                       onError={(e) => {
//                         e.target.src = "https://images.unsplash.com/photo-1561749748-fe2869ba7da4?w=600&auto=format&fit=crop&q=60";
//                       }}
//                     />
//                   </div>
...
const UpcomingEvents = () => {
  ...
  const handleDiscoverMore = (eventId) => {
    navigate("/events");
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {events.map((event, index) => (
              ...
              >
                ...
                {/* Discover More Button - Navigates to Events Page */}
                <button 
                  onClick={() => handleDiscoverMore(event.id)}
                  className="flex items-center gap-2 text-red-600 font-medium hover:underline transition-all duration-200 group"
                >
